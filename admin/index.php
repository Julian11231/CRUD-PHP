          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-label-group">
                <input type="text" id="nombre" name="txt1" class="sinborde" placeholder="Nombre" maxlength="25" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+){2,25}" required autofocus>
                <label for="nombre">Nombre</label>
              </div>
              <div class="form-label-group">
                <input type="text" id="apellido" name="txt2" class="sinborde" placeholder="Apellido" maxlength="50" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+){2,50}" required>
                <label for="apellido">Apellido</label>
              </div>
              <div class="form-label-group">
                <input type="text" id="cedula" name="txt3" class="validanumericos sinborde" placeholder="Cédula" maxlength="10" pattern="[0-9]{10}" required>
