          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-label-group">
                <input type="text" name="txt1" class="sinborde" placeholder="Nombre" value="<?php echo $row['nombre']; ?>" maxlength="25" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+){2,25}" required autofocus>
                <label for="Nombre">Nombre</label>
              </div>
              <div class="form-label-group">
                <input type="text" name="txt2" class="sinborde" placeholder="Apellido" value="<?php echo $row['apellido']; ?>" maxlength="50" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+){2,25}" required>
                <label for="primerApellido">Apellido</label>
              </div>
              <div class="form-label-group">
                <input type="text" name="txt3" class="validanumericos sinborde" placeholder="Cédula" maxlength="10" value="<?php echo $cedula;?>"pattern="[0-9]{10}" required>
